...
int main(void) {
    ...
    while(1){
		...
		snprintf(buff2, sizeof(buff2), "%.2f", wheel_len);

		char buff3[10];
		snprintf(buff3, sizeof(buff3), "%d", (int) get_spd_trig_delta());
		...
		SH1106_I2C_DrawString(buff3, 80, 0, courierNew_10ptFontInfo, 1);
